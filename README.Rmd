...
The goal of `onsvplot` is to provide ggplot theme and color elements to help create graphics in the style of the [Observatório Nacional de Segurança Viária](www.onsv.org.br).
